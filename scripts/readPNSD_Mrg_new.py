...
whichPSD=[[1], [1], [5], [1], [1, 0], [1, 0], [1, 3], [1, 3], [1, 5], [1], [0], [0], [0], [1], [5], [5], [1, 0], [1, 0], [-1], [-1, 0], [-1, 0], [-2], [-2, 0], [-2, 0], [1], [1]]
targetConc=[[500], [5000], [5000], [3000], [3000, 600], [3000, 2000], [3000, 2000], [3000, 4000], [3000, 4000], [5000], [2000], [600], [2000], [3000], [3000], [3000], [3000, 600], [3000, 2000], [1000], [3000, 2000], [3000, 2000], [1000], [1000, 4000], [1000, 4000], [3000], [3000]]
kappa=[[0.61], [0.61], [0.61], [0.61], [0.61, 1.28], [0.61, 1.28], [0.61, 1.28], [0.61, 1.28], [0.61, 1.28], [0.61], [1.28], [1.28], [1.28], [0.067], [0.61], [0.61], [0.067, 1.28], [0.067, 1.28], [0.0], [0.0, 1.28], [0.0, 1.28], [0.0], [0.0, 1.28], [0.0, 1.28], [0.61], [0.61]]
...
comp=[['AS'], ['AS'], ['AS'], ['AS'], ['AS', 'NaCl'], ['AS', 'NaCl'], ['AS', 'NaCl'], ['AS', 'NaCl'], ['AS', 'NaCl'], ['AS'], ['NaCl'], ['NaCl'], ['NaCl'], ['FA'], ['AS'], ['AS'], ['FA', 'NaCl'], ['FA', 'NaCl'], ['SDSA01'], ['SDSA01', 'NaCl'], ['SDSA01', 'NaCl'], ['ATD03'], ['ATD03', 'NaCl'], ['ATD03', 'NaCl'], ['AS'], ['AS']]

density=[[1770], [1770], [1770], [1770], [1770, 2160], [1770, 2160], [1770, 2160], [1770, 2160], [1770, 2160], [1770], [2160], [2160], [2160], [1500], [1770], [1770], [1500, 2160], [1500, 2160], [4000], [4000, 2160], [4000, 2160], [4000], [4000, 2160], [4000, 2160], [1770], [1770]]
